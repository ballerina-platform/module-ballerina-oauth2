...
public function testClientCredentialsGrantType1() {
    ...
    OutboundOAuth2Provider oauth2Provider1 = new({
...
public function testClientCredentialsGrantType2() {
    ...
    OutboundOAuth2Provider oauth2Provider2 = new({
        tokenUrl: "https://localhost:20299/oauth2/token/authorize/header",
...
public function testClientCredentialsGrantType3() {
    ...
    OutboundOAuth2Provider oauth2Provider3 = new({
...
public function testClientCredentialsGrantType4() {
    ...
    OutboundOAuth2Provider oauth2Provider4 = new({
        credentialBearer: http:POST_BODY_BEARER,
        tokenUrl: "https://localhost:20299/oauth2/token/authorize/body",
        clientId: "invalid_client_id",
        clientSecret: "invalid_client_secret",
...
public function testPasswordGrantType1() {
    ...
    OutboundOAuth2Provider oauth2Provider5 = new({
        tokenUrl: "https://localhost:20299/oauth2/token/authorize/header",
        username: "johndoe",
        password: "A3ddj3w",
        clientId: "3MVG9YDQS5WtC11paU2WcQjBB3L5w4gz52uriT8ksZ3nUVjKvrfQMrU4uvZohTftxStwNEW4cfStBEGRxRL68",
...
public function testPasswordGrantType2() {
    ...
    OutboundOAuth2Provider oauth2Provider6 = new({
        tokenUrl: "https://localhost:20299/oauth2/token/authorize/header",
        username: "johndoe",
        password: "A3ddj3w",
        clientId: "3MVG9YDQS5WtC11paU2WcQjBB3L5w4gz52uriT8ksZ3nUVjKvrfQMrU4uvZohTftxStwNEW4cfStBEGRxRL68",
...
public function testPasswordGrantType3() {
    ...
    OutboundOAuth2Provider oauth2Provider7 = new({
        tokenUrl: "https://localhost:20299/oauth2/token/authorize/header",
...
public function testPasswordGrantType4() {
    ...
    OutboundOAuth2Provider oauth2Provider8 = new({
...
public function testDirectToken1() {
    ...
    OutboundOAuth2Provider oauth2Provider9 = new({
...
public function testDirectToken2() {
    ...
    OutboundOAuth2Provider oauth2Provider10 = new({
...
public function testDirectToken3() {
    ...
    OutboundOAuth2Provider oauth2Provider11 = new({
        accessToken: "invalid_access_token",
        refreshConfig: {
            refreshUrl: "https://localhost:20299/oauth2/token/refresh",
...
public function testDirectToken4() {
    ...
    OutboundOAuth2Provider oauth2Provider12 = new({
        accessToken: "invalid_access_token",
        retryRequest: false
    });
...
public function testDirectToken5() {
    ...
    OutboundOAuth2Provider oauth2Provider13 = new({
        accessToken: "invalid_access_token",
        retryRequest: false,
        refreshConfig: {
            refreshUrl: "https://localhost:20299/oauth2/token/refresh",
...
public function testDirectToken6() {
    ...
    OutboundOAuth2Provider oauth2Provider14 = new({
        accessToken: "invalid_access_token",
        refreshConfig: {
            refreshUrl: "https://localhost:20299/oauth2/token/refresh",
...
public function testDirectToken7() {
    ...
    OutboundOAuth2Provider oauth2Provider15 = new({
        accessToken: "2YotnFZFEjr1zCsicMWpAA",
        retryRequest: false
    });
